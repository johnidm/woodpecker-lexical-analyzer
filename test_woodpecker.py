...
class TestWoodpecker(unittest.TestCase, AssertMixin):
    ...
    def test_remove_multiple_spaces(self, mock):
        ...
        self.__should_be("  Your code   is   bad    ", "Your code is bad", "remove_multiple_spaces", mock)
        self.__should_be(" A bug in my       code", "A bug in my code", "remove_multiple_spaces", mock)
        self.__should_be("Rewrite    a   bad code", "Rewrite a bad code", "remove_multiple_spaces", mock)


    @patch("woodpecker.Woodpecker.read_content_file")
    def test_remove_empty_lines(self, mock): 
        code = "Code review?\t\n\tAin't nobody\n\n\ngot time\rfor that\r\n\n."
        self.__should_be(code, "Code review?   Ain't nobody   got time for that   .", "remove_empty_lines", mock)
    ...
    def test_remove_comment(self, mock):
        ...
        self.__should_be("-- That source code -- So hot rigth now", "So hot rigth now", "remove_comment", mock) 
